...
public class Assignment2 {
    ...
    public double socialSecurityTax(Employee employee) {
        ...
        if (employee.salary<=8900){
            double tax=0.062*employee.salary;
            return tax;
        }else{
            double tax=0.062*106800;
            return tax;
        }
    ...
    public static double insuranceCoverage(Employee employee) {
        //write your code here
        if(employee.age<35){
            double i=0.03*employee.salary;
            System.out.println(i);
        }else if(employee.age>=35&&employee.age<=50){
            double i=0.04*employee.salary;
            System.out.println(i);
        }else if(employee.age>50&&employee.age<60){
            double i=0.05*employee.salary;
            System.out.println(i);
        }else{
            double i=0.06*employee.salary;
            System.out.println(i);
        }
    }
    ...
    public void tripleSalary(Employee employee) {
        //write your code here
        int newSalary=3*employee.salary;
